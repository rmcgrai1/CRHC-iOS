...
struct  IOSUnityPlayer_t3656371703  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mScreenOrientation_0() { return static_cast<int32_t>(offsetof(IOSUnityPlayer_t3656371703, ___mScreenOrientation_0)); }
