...
struct  WSAUnityPlayer_t425981959  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mScreenOrientation_0() { return static_cast<int32_t>(offsetof(WSAUnityPlayer_t425981959, ___mScreenOrientation_0)); }
