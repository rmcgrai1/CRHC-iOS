...
struct  ConstructorHandling_t4150360451 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ConstructorHandling_t4150360451, ___value___1)); }
