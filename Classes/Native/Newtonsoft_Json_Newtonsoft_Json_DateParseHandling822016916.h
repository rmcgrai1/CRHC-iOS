...
struct  DateParseHandling_t822016916 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DateParseHandling_t822016916, ___value___1)); }
