...
struct  CommentHandling_t3545414906 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(CommentHandling_t3545414906, ___value___1)); }
