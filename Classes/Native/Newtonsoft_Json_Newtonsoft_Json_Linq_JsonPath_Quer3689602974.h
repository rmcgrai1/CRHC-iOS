...
struct  QueryOperator_t3689602974 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(QueryOperator_t3689602974, ___value___1)); }
