...
struct  LineInfoHandling_t2747370961 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(LineInfoHandling_t2747370961, ___value___1)); }
