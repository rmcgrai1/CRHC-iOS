...
struct  MemberSerialization_t687984360 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MemberSerialization_t687984360, ___value___1)); }
