...
struct  NullValueHandling_t3618095365 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(NullValueHandling_t3618095365, ___value___1)); }
