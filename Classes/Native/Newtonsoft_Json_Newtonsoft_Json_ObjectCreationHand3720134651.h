...
struct  ObjectCreationHandling_t3720134651 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ObjectCreationHandling_t3720134651, ___value___1)); }
