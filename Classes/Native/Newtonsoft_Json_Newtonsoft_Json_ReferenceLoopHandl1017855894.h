...
struct  ReferenceLoopHandling_t1017855894 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ReferenceLoopHandling_t1017855894, ___value___1)); }
