...
struct  DefaultReferenceResolver_t1062508680  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of__referenceCount_0() { return static_cast<int32_t>(offsetof(DefaultReferenceResolver_t1062508680, ____referenceCount_0)); }
