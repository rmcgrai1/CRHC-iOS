...
struct  JsonContractType_t4218948260 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(JsonContractType_t4218948260, ___value___1)); }
