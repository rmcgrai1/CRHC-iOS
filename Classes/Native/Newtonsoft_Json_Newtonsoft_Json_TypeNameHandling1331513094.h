...
struct  TypeNameHandling_t1331513094 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(TypeNameHandling_t1331513094, ___value___1)); }
