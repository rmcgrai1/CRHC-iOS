...
struct  DictionaryEnumerator_2_t2758714162 
{
public:
...
public:
	inline static int32_t get_offset_of__e_0() { return static_cast<int32_t>(offsetof(DictionaryEnumerator_2_t2758714162, ____e_0)); }
