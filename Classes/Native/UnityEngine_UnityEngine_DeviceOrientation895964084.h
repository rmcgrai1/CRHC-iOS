...
struct  DeviceOrientation_t895964084 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DeviceOrientation_t895964084, ___value___1)); }
