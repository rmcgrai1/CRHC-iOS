...
public:
	...
	VideoModeData_t3451594282  ___mVideoModeData_9;
...
public:
	inline static int32_t get_offset_of_mCameraImages_1() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mCameraImages_1)); }
	inline Dictionary_2_t3085942560 * get_mCameraImages_1() const { return ___mCameraImages_1; }
	inline Dictionary_2_t3085942560 ** get_address_of_mCameraImages_1() { return &___mCameraImages_1; }
	inline void set_mCameraImages_1(Dictionary_2_t3085942560 * value)
	{
		___mCameraImages_1 = value;
		Il2CppCodeGenWriteBarrier(&___mCameraImages_1, value);
	}

	inline static int32_t get_offset_of_mForcedCameraFormats_2() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mForcedCameraFormats_2)); }
	inline List_1_t2379651176 * get_mForcedCameraFormats_2() const { return ___mForcedCameraFormats_2; }
	inline List_1_t2379651176 ** get_address_of_mForcedCameraFormats_2() { return &___mForcedCameraFormats_2; }
	inline void set_mForcedCameraFormats_2(List_1_t2379651176 * value)
	{
		___mForcedCameraFormats_2 = value;
		Il2CppCodeGenWriteBarrier(&___mForcedCameraFormats_2, value);
	}

	inline static int32_t get_offset_of_mCameraReady_4() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mCameraReady_4)); }
	...
	inline static int32_t get_offset_of_mIsDirty_5() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mIsDirty_5)); }
	...
	inline static int32_t get_offset_of_mActualCameraDirection_6() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mActualCameraDirection_6)); }
	...
	inline static int32_t get_offset_of_mSelectedCameraDirection_7() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mSelectedCameraDirection_7)); }
	...
	inline static int32_t get_offset_of_mCameraDeviceMode_8() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mCameraDeviceMode_8)); }
	...
	inline static int32_t get_offset_of_mVideoModeData_9() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mVideoModeData_9)); }
	inline VideoModeData_t3451594282  get_mVideoModeData_9() const { return ___mVideoModeData_9; }
	inline VideoModeData_t3451594282 * get_address_of_mVideoModeData_9() { return &___mVideoModeData_9; }
	inline void set_mVideoModeData_9(VideoModeData_t3451594282  value)
	{
		___mVideoModeData_9 = value;
	}

	inline static int32_t get_offset_of_mVideoModeDataNeedsUpdate_10() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mVideoModeDataNeedsUpdate_10)); }
	...
	inline static int32_t get_offset_of_mHasCameraDeviceModeBeenSet_11() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mHasCameraDeviceModeBeenSet_11)); }
	...
	inline static int32_t get_offset_of_mCameraActive_12() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511, ___mCameraActive_12)); }
...
struct CameraDeviceImpl_t610967511_StaticFields
{
public:
...
public:
	inline static int32_t get_offset_of_mWebCam_3() { return static_cast<int32_t>(offsetof(CameraDeviceImpl_t610967511_StaticFields, ___mWebCam_3)); }
