...
struct  DistortionRenderingMode_t3766399464 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(DistortionRenderingMode_t3766399464, ___value___1)); }
