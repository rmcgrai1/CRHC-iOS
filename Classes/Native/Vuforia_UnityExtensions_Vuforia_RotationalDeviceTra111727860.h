...
struct  MODEL_CORRECTION_MODE_t111727860 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(MODEL_CORRECTION_MODE_t111727860, ___value___1)); }
