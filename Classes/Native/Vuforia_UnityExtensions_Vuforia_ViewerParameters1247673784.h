...
struct  ViewerParameters_t1247673784  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_mNativeVP_0() { return static_cast<int32_t>(offsetof(ViewerParameters_t1247673784, ___mNativeVP_0)); }
