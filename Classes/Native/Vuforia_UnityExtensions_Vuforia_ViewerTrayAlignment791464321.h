...
struct  ViewerTrayAlignment_t791464321 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ViewerTrayAlignment_t791464321, ___value___1)); }
