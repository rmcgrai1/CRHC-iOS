...
struct  WorldCenterMode_t3506117492 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(WorldCenterMode_t3506117492, ___value___1)); }
