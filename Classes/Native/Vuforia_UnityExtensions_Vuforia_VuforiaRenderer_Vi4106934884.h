...
struct  VideoBackgroundReflection_t4106934884 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(VideoBackgroundReflection_t4106934884, ___value___1)); }
