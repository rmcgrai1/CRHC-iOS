...
struct  WordTemplateMode_t1097144495 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(WordTemplateMode_t1097144495, ___value___1)); }
