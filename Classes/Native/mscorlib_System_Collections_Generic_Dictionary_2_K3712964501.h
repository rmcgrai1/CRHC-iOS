...
struct  KeyCollection_t3712964501  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_dictionary_0() { return static_cast<int32_t>(offsetof(KeyCollection_t3712964501, ___dictionary_0)); }
