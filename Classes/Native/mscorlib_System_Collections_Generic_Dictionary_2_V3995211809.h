...
struct  ValueCollection_t3995211809  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_dictionary_0() { return static_cast<int32_t>(offsetof(ValueCollection_t3995211809, ___dictionary_0)); }
