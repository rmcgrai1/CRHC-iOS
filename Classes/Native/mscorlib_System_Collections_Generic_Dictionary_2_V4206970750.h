...
struct  ValueCollection_t4206970750  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_dictionary_0() { return static_cast<int32_t>(offsetof(ValueCollection_t4206970750, ___dictionary_0)); }
